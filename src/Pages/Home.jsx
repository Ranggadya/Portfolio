...
const WORDS = ["Front End Developer", "Back-End Developer", "Wed Design "]; // Teks Berjalan
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"]; // Skill di Home
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Ranggadya" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/ranggadya/" },
  { icon: Instagram, link: "https://www.instagram.com/rnggdyar/" }
];
