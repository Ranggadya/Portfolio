...
import { SiJavascript, SiMysql, SiAwsamplify } from "react-icons/si";
...
// ⬅️ Pastikan import icon yang kamu butuhkan


const TechStackMotion = memo(() => {
  const technologies = [
  ...
  return (
    <div
      className="w-full mt-8 mb-4 overflow-hidden"
      data-aos="fade-up"
      data-aos-duration="1000"
    >
      <div className="text-center mb-4">
        <h3 className="text-lg sm:text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7] mb-1">
          Tech Stack
        </h3>
      ...
      <div className="relative">
        ...
        <div className="flex animate-scroll-left">
          {duplicatedTech.map((tech, index) => (
            ...
            >
              <div className="relative">
                <div className="bg-gradient-to-r from-gray-700 to-gray-800 p-0.5 rounded-lg transition-all duration-300 group-hover:scale-105 group-hover:shadow-md">
                  <div className="bg-gray-900 rounded-lg px-3 py-2 flex items-center gap-2 min-w-[100px]">
                    <tech.icon
                      className={`${tech.color} w-5 h-5 group-hover:scale-110 transition-transform duration-300`}
                    />
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/drive/folders/1s6GUoOx4seqp_TpiBWuWJtGNRlAKuTKc?usp=sharing" className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
